...
const form = useForm({
    ...
    values: props.about.values ? [...props.about.values] : [],
});
...
const addValue = () => {
    form.values.push({ title: '', desc: '', icon: '' });
};
        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <section class="rounded-xl border border-border bg-card overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    <div>
                        <label class="block text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Hero Title</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Hero Subtitle</label>
            ...
            <section class="rounded-xl border border-border bg-card overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    <div>
                        <label class="block text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Home Snippet Title</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Snippet Text Content</label>
            ...
            <section class="rounded-xl border border-border bg-card overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    <div>
                        <label class="block text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Purpose Title</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Purpose Description</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Mission Statement</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Vision Statement</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Company Backing / Affiliation</label>
                ...
                <div class="p-6 space-y-4">
                    <div v-for="(value, index) in form.values" :key="index" class="p-5 border border-border rounded-lg bg-muted/10 relative group">
                        ...
                        <div class="space-y-4 pr-10">
                            <div>
                                <label class="block text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Value Title</label>

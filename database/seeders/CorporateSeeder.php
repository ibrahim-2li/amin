...
class CorporateSeeder extends Seeder
{
    ...
    private function seedDivisionsAndServices(): void
    {
        $divisions = [
            [
                ...
                'description' => 'e7 Security is a leader in secure printing and identity management, delivering end-to-end data protection solutions for banking, government, telecom, retail, hospitality, and transport sectors across the UAE and beyond.',
                'long_description' => "e7 Security operates at the forefront of secure printing and identity management. We design, produce, and personalize identity documents and security credentials that protect citizens, organizations, and governments in an increasingly complex world.\n\nOur solutions span the full identity lifecycle — from biometric passport production and smart national ID cards to digital authentication infrastructure and PKI systems. We combine cutting-edge cryptographic technologies with tamper-evident physical substrates, delivering credentials trusted by sovereign authorities and enterprise clients across the region.\n\nServing banking, government, telecom, retail, hospitality, and transport sectors, e7 Security brings decades of specialised expertise and a proven track record of delivery at national scale. Every solution we produce is built to the most rigorous international standards, ensuring our clients can operate with complete confidence.",
            ...
            [
                'name' => 'e7 Education',
                'slug' => 'e7-education',
                'tagline' => 'Innovative educational products and solutions for UAE public and private institutions.',
                'description' => 'Established in 2019, e7 Education supplies innovative educational products and solutions to UAE public and private institutions, offering expert consultations aimed at developing competitive educational systems.',
                'long_description' => "Established in 2019, e7 Education was founded with a clear mission: to empower UAE educational institutions with the products, solutions, and expertise needed to build world-class learning environments.\n\nWe work directly with the UAE's public and private education sector — from the Ministry of Education and Abu Dhabi Department of Education and Knowledge (ADEK) to individual schools and universities — providing comprehensive educational solutions that cover the full spectrum of institutional needs.\n\nOur team of curriculum specialists, educational technologists, and instructional designers collaborates closely with institutions to understand their unique requirements and develop tailored solutions. We go beyond product supply to offer genuine consulting and development support, helping institutions evolve their educational systems to compete on a global level.",
    ...
    private function seedPartners(): void
    {
        $partners = [
            ...
            ['name' => 'Ministry of Interior UAE', 'category' => 'government'],
    ...
    {
        $settings = [
            ['key' => 'company_name', 'value' => 'e7 Group', 'type' => 'string'],
            ['key' => 'company_tagline', 'value' => 'Trusted Solutions for Your Business Across the UAE', 'type' => 'string'],
            ...
            ['key' => 'contact_email', 'value' => 'info@e7group.ae', 'type' => 'string'],
            ['key' => 'contact_phone', 'value' => '+971 600500877', 'type' => 'string'],
            ['key' => 'contact_address', 'value' => 'Plot 220, Old Shahama, Abu Dhabi, UAE', 'type' => 'string'],
            ['key' => 'founded_year', 'value' => 'ADQ', 'type' => 'string'],
            ['key' => 'countries_served', 'value' => 'UAE+', 'type' => 'string'],
